/*
  # Mini-Games Schema for 5Chairs Bot
...
-- Allow public read access (since this is for group meetings)
...
CREATE POLICY "Allow public insert to game_participants"
  ON game_participants FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow public update to game_participants"
  ON game_participants FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow public delete from game_participants"
